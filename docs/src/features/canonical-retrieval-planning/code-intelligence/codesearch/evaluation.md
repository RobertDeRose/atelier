...
The first evidence report is in [the evaluation report](research/evaluation-2026-07-21.md). The bounded self-hosting result and live-run diagnostics are in [the retrieval economy report](research/retrieval-economy-2026-07-27.md).
