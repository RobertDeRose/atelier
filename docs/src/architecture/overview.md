...
Atelier cannot attribute it to the active primary task. The delivered [Exact Plan Execution](../features/exact-plan-execution/index.md) record preserves its implementation evidence.
...
without waiting for idle. The delivered [Exact Plan Execution](../features/exact-plan-execution/index.md) and [Mutation and Validation Evidence](../features/mutation-validation-evidence/index.md) records preserve the implementation evidence.
